...
require ('../../Connections/laboratory.php');
    ...
    //$db = "SELECT * FROM `complaints` WHERE complaintStatus = 1";
    $db = "SELECT c.complaintID, c.complaintProblem, c.complaintStatus, l.labName, et.equipTypeName FROM complaints c, lab l, equipment_type et WHERE c.complaintID = c.complaintID AND c.labNo = l.labNo AND c.equipTypeID = et.equipTypeID AND c.complaintStatus = 1";
    $ress = mysql_query($db) or die('Error');
?>

<?php
require ('../../Connections/laboratory.php');

    //$query = "SELECT c.complaintID, c.labName, c.complaintProblem, c.complaintStatus, m.maintCosting, m.maintDateTime FROM maintenance m, complaints c WHERE m.maintID = c.maintID AND c.complaintStatus = 1";
    $query = "SELECT m.maintDateTime, m.maintSolution, m.maintCosting, m.maintStatus, c.complaintID, c.complaintProblem, l.labName FROM complaints c, maintenance m, lab l WHERE m.maintID = m.maintID AND m.complaintID = c.complaintID AND c.labNo = l.labNo AND c.complaintStatus = '2'";
...
require ('../../Connections/laboratory.php');
    ...
    $sql = "SELECT SUM(maintCosting) FROM complaints c, maintenance m WHERE m.maintID = m.maintID AND m.complaintID = c.complaintID AND c.complaintStatus = 2";
...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Lab Maintenance</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                                            ...
                                            echo '<tr>
                                                    ...
                                                    <td>
                                                        <form method="post" action="defective_equip_maintenance_disposal-action.php">
                                                            ...
                                                            <a href="defective_equip_maintenance-update.php?complaintID='.$row['complaintID'].'&staffid='.$id.'" class="btn btn-default"><i class="fa fa-refresh fa-fw"></i>Update</a>

                                                            <input type="hidden" name="complaintID" value='.$row['complaintID'].'></input>
                                                            <button class="btn btn-danger" name="cancel"><i class="fa fa-times fa-fw"></i>Cancel</button>
                                            ...
                                            echo '<tr>
                                                    ...
                                                    <td>
                                                        <form method="post" action="defective_equip_maintenance_disposal-action.php">
                                                            ...
                                                            <button class="btn btn-primary" name="success"><i class="fa fa-check-square-o fa-fw"></i>Successful</button>
