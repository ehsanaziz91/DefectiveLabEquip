...
}else
{
    ...
    //$query = "SELECT * FROM `complaints` WHERE disposal = 1";
    $query = "SELECT c.complaintID, c.complaintProblem, l.labName, et.equipTypeName FROM complaints c, lab l, equipment_type et WHERE c.complaintID = c.complaintID AND c.labNo = l.labNo AND c.equipTypeID = et.equipTypeID AND c.disposal = 1";
...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Disposal Equipment</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            List of Disposal Lab Equipment
                        </div>
                        <!-- /.panel-heading -->
