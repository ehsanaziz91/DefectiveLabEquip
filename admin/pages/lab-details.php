...
if (isset($_GET['labNo']))
{
	...
	$labname = $row['labName'];
	$labloca = $row['labLocation'];

    //$query = "SELECT lab.*, lab_equipment.* FROM lab,lab_equipment WHERE `labNo` = '$labno'";
    //SELECT lab.*, equipment_type.*, lab_equipment.* FROM lab,lab_equipment,equipment_type;
	
}

if (isset($_POST['update']))
{
    header("Location: lab-details-update.php?labNo=$labno");
}
...
if (isset($_POST['del']))
{
    ...
    if($res)
    {
        ...
        echo "alert('Deleted data successfully'),location.href='lab.php?";
        echo "</script>";
    }
    else
    {
...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Laboratory Details</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" id="disabledInput" type="text"  name="labname" value="<?php echo $labname; ?>" disabled>
                                        </div>
                                        <div class="form-group">
                                            <label for="disabledSelect">Lab Assistance Name</label>
                                            <input class="form-control" id="disabledInput" type="text" name="laname" disabled>
                                        </div>
                                        <div class="form-group">
                                            <label for="disabledSelect">Action</label>
                                            <input class="form-control" id="disabledInput" type="text" name="action" disabled>
                                        </div>
                                        <button type="submit" class="btn btn-primary" name="update">Update Lab</button>
                                        <button type="delete" class="btn btn-danger" name="del">Delete Lab</button>
                                    </div>
                                    <!-- /.col-lg-6 (nested) -->
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            <label for="disabledSelect">Lab Location</label>
                                            <input class="form-control" id="disabledInput" type="text" name="labloca" value= "<?php echo $labloca; ?>" disabled>
                                        </div>
                                        <div class="form-group">
                                            <label for="disabledSelect">Status</label>
                                            <input class="form-control" id="disabledInput" type="text" name="status" disabled>
                                        </div>
                                        <div class="form-group">
                                            <label for="disabledSelect">Tasks</label>
                                            <input class="form-control" id="disabledInput" type="text"  name="tasks" disabled>
                                        </div>
                                    </div>
                                    <!-- /.col-lg-6 (nested) -->
                                </div>
