...
require ('../../Connections/laboratory.php');
    ...
    $query = "SELECT c.complaintID, c.labName, c.complaintProblem, c.complaintDate, c.complaintTime, c.complaintSolution, c.maintenance, s.staffName, et.equipTypeName FROM staff s, complaints c, lab_equipment le, equipment_type et WHERE s.staffID = c.staffID AND c.labEquipmentID = le.labEquipmentID AND le.equipTypeID = et.equipTypeID AND c.maintenance = 1";
...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Lab Maintenance (Successful)</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                    ...
                    <div class="col-lg-12">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                List of Lab Equipment Maintenance (Successful)
                            </div>
                            <!-- /.panel-heading -->
