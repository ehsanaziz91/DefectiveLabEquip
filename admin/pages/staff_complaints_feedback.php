...
}else
{
    ...
    //$query = "SELECT * FROM `complaints` WHERE staffID = '$staffid' AND complaintStatus=3";
    //$query = "SELECT c.complaintID, c.labName, c.complaintProblem, c.equipTypeName, m.maintID, m.maintSolution, m.maintStatus, m.maintDateTime FROM maintenance m, complaints c WHERE c.staffID = '$staffid' AND c.complaintStatus = 3";
    $query = "SELECT m.maintID, m.maintDateTime, m.maintSolution, m.maintStatus, c.complaintID, c.complaintProblem, l.labName, et.equipTypeName FROM maintenance m, complaints c, lab l, equipment_type et WHERE m.maintID = m.maintID AND m.complaintID = c.complaintID AND c.complaintProblem = c.complaintProblem AND c.labNo = l.labNo AND c.equipTypeID = et.equipTypeID AND c.staffID = '$id' AND c.complaintStatus = '3'";
...
<head>
    ...
    <title>Staff Complaints Feedback</title>
...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Complaints Feedback</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                            ...
                            <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                                ...
                                <tbody>
                                     <?php
                                        ...
                                        {
                                            echo '<tr>
                                                    <td align="center"><a href="staff_complaints_list.php?staffid='.$id.'">'.$row['complaintID'].'</a></td>
                                                    <td>'.$row['labName'].'</td>
