...
if (isset($_GET['complaintID']))
{
    ...
    $query = "SELECT c.complaintID, c.complaintProblem, c.complaintDateTime, c.complaintStatus, s.staffName, l.labName, et.equipTypeName
    FROM complaints c, staff s, lab l, equipment_type et
    WHERE c.complaintID = '$compid' AND c.staffID = s.staffID AND c.labNo = l.labNo AND c.equipTypeID = et.equipTypeID";
...
if (isset($_POST['back']))
{
    header("Location: reported_complaints.php?assistid=$id");
}
?>
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        ...
                                        <tr>
                                            ...
                                            <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                                            <td>:</td>
                                            <td><?php echo $row['equipTypeName'];?></td>
                                        </tr><br><br>
                                        <tr>
