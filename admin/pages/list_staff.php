                            ...
                            <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                                ...
                                <tbody>
                                     <?php
                                        ...
                                        {
                                            echo '<tr>
                                                    <td align="center">'.$row['staffID'].'</td>
                                                    <td>'.$row['staffName'].'</td>
                                                    <td>'.$row['position'].'</td>
                                                    <td>
                                                        <form method="post" action="delete.php?staffID='.$row['staffID'].'">

                                                            <input type="hidden" name="staffID" value='.$row['staffID'].'></input>

                                                            <button class="btn btn-danger" name="del_staff"><i class="fa fa-trash-o fa-fw"></i>Delete</button>
