...
}else
{
    ...
    $query = "SELECT l.labNo, l.labName, l.labLocation, la.labAssistName, et.equipTypeName FROM lab l, lab_assistance la, equipment_type et WHERE l.labNo = l.labNo AND l.labAssistID = la.labAssistID AND l.equipTypeID = et.equipTypeID";
