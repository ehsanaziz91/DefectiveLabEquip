...
if (isset($_GET['complaintID']))
{
    ...
    $query = "SELECT c.complaintID, c.complaintProblem, c.complaintDateTime, c.complaintStatus, s.staffName, l.labName, et.equipTypeName FROM complaints c, staff s, lab l, equipment_type et WHERE c.complaintID = '$compid' AND c.staffID = s.staffID AND c.labNo = l.labNo AND c.equipTypeID = et.equipTypeID";
...
if (isset($_POST['back']))
{
    header("Location: defective_equip.php?assistid=$id");
}
?>
...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Lab Equipment Problems Details</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                            ...
                            <div class="panel-body">
                                <div class="row">
                                    <div class="col-lg-12">
                                        ...
                                        <tr>
                                            <td>Complaint Date & Time</td>
                                            <td>
                                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                            </td>
                                            <td>:</td>
                                            <td><?php echo $row['complaintDateTime'];?></td>
                                        </tr><br><br>
                                        <tr>
                                            <td>Complaint Problems</td>
                                            <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                                            <td>:</td>
                                            <td><?php echo $row['complaintProblem'];?></td>
                                        </tr><br><br>
                                        <tr>
