...
if (isset($_GET['complaintID']))
{
    ...
    $query = "SELECT c.complaintID, c.complaintProblem, c.complaintDateTime, s.staffName, l.labName, et.equipTypeName FROM complaints c, lab l, staff s, equipment_type et WHERE c.complaintID = '$compid' AND c.staffID = s.staffID AND c.labNo = l.labNo AND c.equipTypeID = et.equipTypeID";
    $res = mysql_query($query) or die('Error');
}

if (isset($_POST['back']))
{
    header("Location: staff_complaints_list.php?staffid=$id");
}
?>
...
<head>
    ...
    <title>Staff Complaints Details</title>
...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Details of Complaints</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
                            ...
                            <div class="panel-body">
                                <div class="row">
                                    <div class="col-lg-12">
                                        ...
                                        echo '<tr>
                                            <td>Problem Date Time</td>
                                            <td>&nbsp;</td>
                                            <td>:</td>
                                            <td>'.$row['complaintDateTime'].'</td>
                                        </tr><br><br>';
                                        echo '<tr><button type="submit" class="btn btn-default" name="back">Back</button>
                                        </tr>';
                                            }
                                        ?>
                                    </div>
