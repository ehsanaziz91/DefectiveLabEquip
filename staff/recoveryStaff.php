...
if (isset($_GET['staffid']))
	...
	if (mysql_num_rows($result) == 1)
		{
			header("Location:recoAnswerStaff.php?staffid=$staffid");
		}
	  else
		{
		...
		<div class="container-login100" style="background-image: url('images/bg-01.jpg');">
			<div class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-54">
				<form class="login100-form validate-form" method="get">
					...
					<p>You can use this form to recover your password if you have forgotten it. Enter your staff id below to get started.</p>
					<br>

					<div class="wrap-input100 validate-input m-b-23" data-validate = "StaffID is required">
						<span class="label-input100">Staff ID</span>
						<input class="input100" type="text" name="staffid" placeholder="Insert your staff id">
