...
if (isset($_POST['signup']))
	...
	$answer = $_POST['answer'];
	$sql = mysql_query("INSERT INTO lab_assistance (labAssistID, labAssistName, password, position, recoQuestion1, recoAnswer1) 
  		VALUES ('$id', '$fullname', '$rpass', '$position', '$question', '$answer')");

	if ($sql)
		{
		print "<script type=\"text/javascript\">";
		print "alert('Successfully Registered'),location.href='loginAssistance.php'";
		print "</script>";
		}
	  else
		{
...
<html lang="en">
<head>
	<title>Lab Assistance Signup</title>
	<meta charset="UTF-8">
			...
			<div class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-54">
				<form class="login100-form validate-form" method="post">
					...
					<div class="wrap-input100 validate-input m-b-23" data-validate = "Lab Assistance ID is required">
						...
						<input class="input100" type="text" name="rassistid" placeholder="Type your lab assistance id">
					...
					<div class="text-right p-t-8 p-b-31">
						<a href="loginAssistance.php">Already have Account?</a>
					</div>
