...
if (isset($_POST['login']))
	...
	$query = "SELECT * FROM `lab_assistance` WHERE `labAssistID` = '$id' And `password` = '$pass' ";
	$result = mysql_query($query) or die('Error');
	$login = mysql_fetch_array($result, MYSQL_ASSOC);
	$que = "select * from lab_assistance where labAssistID='$id'";
	...
	if (mysql_num_rows($result) == 1)
		{
            ...
            $_SESSION['assistid'] = $id;
            header("Location: ../admin/pages/index.php?assistid=$id");
...
<html lang="en">
<head>
	<title>Lab Assistance Login</title>
	<meta charset="UTF-8">
			...
			<div class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-54">
				<form class="login100-form validate-form" method="post">
					...
					<div class="wrap-input100 validate-input m-b-23" data-validate = "Lab Assistance ID is required">
						...
						<input class="input100" type="text" name="assistid" placeholder="Type your lab assistance id">
					...
					<div class="text-right p-t-8 p-b-31">
						<a href="recoveryAssistance.php">Forgot password?</a>
					</div>
					...
					<div class="flex-col-c p-t-155-l">
						<a href="signupAssistance.php" class="txt2">Sign Up</a>
					</div>
				</form>
			</div>
		</div>
